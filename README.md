...
Also, open build.gradle(Project: *) file from Project > build.gradle add these lines
```gradle
buildscript {
    dependencies {
...
Also, open build.gradle(Module: *.app) file from Project > app> build.gradle and add this line
```gradle
...
and inside dependencies add this line
```gradle
dependencies {
	...
...
### Step 5: Add `google-services.json` file into the module(app-level) directory of your app (optional)
...
Open file gradle.properties from Project > gradle.properties and add  line
```gradle
android.useAndroidX=true
android.enableJetifier=true
```
### Step 7: Sync your gradle files
The setup requied for using the Flextudio SDK in your app is already complete. Press *Sync Now* to load dependencies to your local machine. (File > Sync Project with Gradle Files)

### Step 8: Run app
Now, build  and run the project.
Run >   Run or  press Alt+Shift+F10 keys.